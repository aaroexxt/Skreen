...
sudo npm install --unsafe-perm=true -g --allow-root --save-prod git://github.com/Kolky/nodetunes.git#master
sudo npm install --unsafe-perm=true -g --allow-root --build-from-source --save-prod serialport;
sudo npm install --unsafe-perm=true -g --allow-root --save-prod speaker;
sudo npm install --unsafe-perm=true -g --allow-root --save-prod mp3-duration pcm-volume lame window-size
